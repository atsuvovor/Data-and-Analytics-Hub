...
<head>
    ...
    <meta name="description" content="Welcome to the Data Management & Analytics Design Lab, where innovation meets data excellence.">
    <title>Data Management & Analytics Design Lab</title>
